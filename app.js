...
// déclaration de notre fichier statique public pour que le client puisse être servi.
...
// tous nos modules de routes
app.use('/', index);
//app.use('/users', users);
app.use('/auth', auth)

// pour attraper les erreurs 404 et les diriger vers le error handler
